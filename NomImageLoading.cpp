...
unsigned int NomImageLoading::getNextPow2(unsigned int in_src)
{
...
void NomImageLoading::findImageNonEmptyArea(const unsigned char * in_data, const atl::size2f & in_imageDim, atl::box2f & out_nonEmptyArea)
{
...
void NomImageLoading::diagReset()
{
#ifdef DEBUG
    g_bytesAllocated = 0;
    g_bytesEmpty = 0;
...
void NomImageLoading::diag(const unsigned char * in_data, unsigned int in_width, unsigned int in_height, const std::string & in_ident)
{
#ifdef DEBUG

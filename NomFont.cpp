...
NomFont::NomFont(const std::string & in_fontName,
...
NomFontChar::NomFontChar(char in_char,
                         float in_advance,
...
void NomFontResource::loadFromFile(const std::string & inFileName)
{
    //
...
NomFontResource::~NomFontResource()
{
    delete pmFont;
}
